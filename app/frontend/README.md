...
<details>
  ...
  * Data para entrega final do projeto: `13/02/2023 14:00`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-026-b-project-recipes-app.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-026-b-project-recipes-app`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-026-b-project-recipes-app/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-026-b-project-recipes-app/pulls) e confira que o seu _Pull Request_ está criado
